        ...
        <div className="pt-6 md:p-8 text-center md:text-left space-y-4">
          <blockquote>
            <p className="text-lg font-semibold">
              {title} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem blanditiis cum cumque deleniti,
              dignissimos dolor, eos et illum in inventore ipsam itaque iure iusto nostrum, nulla pariatur quia sequi
              vitae!
            </p>
          </blockquote>
